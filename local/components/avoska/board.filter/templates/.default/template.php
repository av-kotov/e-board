    ...
    <form action="<?=$arResult['LIST_URL']?>" method="get" class="board-filter__form">
        ...
        <div class="board-filter__row">
            ...
            <input type="text" name="q"
                   value="<?=htmlspecialcharsbx($r['q'])?>"
                   class="board-filter__input"
            ...
            <div class="board-filter__row">
                ...
                <select name="city" class="board-filter__input">
                    ...
                    <?php foreach ($arResult['CITIES'] as $city): ?>
                        <option value="<?=htmlspecialcharsbx($city)?>"
                            <?=($r['city'] === $city ? ' selected' : '')?>>
        ...
        <div class="board-filter__row">
            ...
            <div class="board-filter__range">
                <input type="text" name="price_from"
                       value="<?=htmlspecialcharsbx($r['price_from'])?>"
                       class="board-filter__input board-filter__input--sm"
                       placeholder="от">
                <input type="text" name="price_to"
                       value="<?=htmlspecialcharsbx($r['price_to'])?>"
                       class="board-filter__input board-filter__input--sm"
                       placeholder="до">
            </div>
        </div>
